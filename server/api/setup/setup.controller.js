...
exports.check = function(req, res) {
  ...
  var generateSetupCommand = function(username, password, websiteName, websiteURL, city, state, country, v65plus) {
    ...
    return "casperjs ./one-click-casper-scripts/designerLaunch.js" + " " + username + " " + password + " " + escapeShell(websiteName) + " " + websiteURL + " " + escapeShell(city) + " " + escapeShell(state) + " " + country + " " + v65plus;
  };
